        ...
        <nav class="navbar navbar-dark bg-dark py-4 mb-5">
            <div class="container-fluid py-2">
                    <a class="navbar-brand sign" style="font-size: 40px" href="/hiena">
                        ...
                        <span class="fast-flicker">site</span>
                    </a>
                ...
                <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
                    ...
                    <div class="offcanvas-body">
                        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active neonText" href="/stock">
                                    <i class="fa-solid fa-cart-shopping fa-2xs me-2"></i>
                                    Магазин
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active" href="/serverMap">
                                    <i class="fa-solid fa-map-location fa-2xs me-2"></i>
                                    Карта сервера
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active" href="/staff">
                                    <i class="fa-solid fa-masks-theater fa-2xs me-2"></i>
                                    Заявки в стафф
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active neonText" href="/news">
                                    <i class="fa-solid fa-gift fa-2xs me-2"></i>
                                    Розыгрыши и обновления
                                </a>
                            </li>
                            <li class="nav-item mb-5">
                                <a class="nav-link active mb-4" href="https://boosty.to/naibu">
                                    <i class="fa-solid fa-circle-dollar-to-slot fa-2xs me-2"></i>
        ...
        <footer style="margin-top: 200px; border-top: 1px solid dimgrey; font-family: 'Raleway', sans-serif">
            <div class="container-fluid py-5" style=" color: dimgrey; background-color: #202529">
                <div class="small text-center text-muted">
                    <div class="row">
                        <div class="col-6">
                            <h4 class="neonStatic">Ссылки проекта</h4>
                            <h6 class="mt-3">
                                <a href="https://discord.gg/UTbWZK6nQM" style="text-decoration: none; color: dimgrey">Сервер Hiena</a>
                            </h6>
                            <h6 class="mt-1">
                                <a href="https://boosty.to/naibu" style="text-decoration: none; color: dimgrey">Boosty (поддержи нас)</a>
                            </h6>
                            <h6 class="mt-1">
                                <a href="https://t.me/+kuaQuiurt19mMmUy" style="text-decoration: none; color: dimgrey">Беседка Telegram</a>
                            </h6>
                        </div>
                        <div class="col-6">
                            <h4 class="neonStatic">Контакты с разработчиками</h4>
                            <h6 class="mt-3">
                                <a href="https://t.me/nanassshii" style="text-decoration: none; color: dimgrey">Telegram админа/автора сайта</a>
                            </h6>
                            <h6 class="mt-1">
                                <a style="text-decoration: none; color: dimgrey">Discord админа: Naibu#2222</a>
                            </h6>
                            <h6 class="mt-2">
                                <a href="https://t.me/ndsamq" style="text-decoration: none; color: dimgrey">Telegram партнера</a>
                            </h6>
                            <h6 class="mt-1">
                                <a href="https://ggsel.net/sellers/1128388" style="text-decoration: none; color: dimgrey">Площадка партнера</a>
                            </h6>
                        </div>
                    </div>
                </div>
