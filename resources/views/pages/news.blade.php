    ...
    <div class="container mx-auto col-sm-12 col-lg-8">
        @foreach($events as $event)
            @if($event->card_style == "1")
                <div class='card review' style='height: auto; border: 2px solid white; box-shadow: 0px 0px 3px 1px white; margin-top: 70px; background-color: rgba(32,37,41, 0.9);'>
            ...
            @elseif($event->card_style == "3")
                <div class="card mb-3 review" style="width: auto; height: auto; border: 2px solid white; box-shadow: 0px 0px 3px 1px white; margin-top: 70px; background-color: rgba(32,37,41, 0.9);">
                    <div class="row g-0">
